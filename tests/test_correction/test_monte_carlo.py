...
def apply_error_variation_for_testing(base_result: xr.Dataset, param_idx: int, test_mode_config: TestModeConfig) -> xr.Dataset:
    """
...
python test_monte_carlo.py --mode upstream --iterations 5
    ...
    parser.add_argument(
        '--mode',
        type=str,
        choices=['upstream', 'downstream', 'unittest'],
        required=True,
    ...
    parser.add_argument(
        '--quick',
        action='store_true',
        help='Quick test (2 iterations, test case 1 only)'
    )
    parser.add_argument(
        '--iterations',
        type=int,
    ...
    parser.add_argument(
        ...
        nargs='+',
        default=None,
        help='Specific test cases for downstream mode (e.g., 1 2 3)'
    )
    parser.add_argument(
        '--output-dir',
        type=str,
    ...
    if args.mode == 'unittest':
        ...
        results_list, results_dict, output_file = test_upstream_pipeline(
            n_iterations=n_iterations,
            work_dir=work_dir
        )
