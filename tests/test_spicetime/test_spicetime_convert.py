...
class AdaptTestCase(unittest.TestCase):
    ...
    def test_tsis_to_utc_handles_2d_array(self):
        ...
        self.assertListEqual(
            [
                ["2017-12-14", "2017-12-15", "2017-12-16"],
    ...
    def test_scalar(self):
        ...
        for ttype in self.ttypes:
            with self.subTest(ttype=ttype):
                ...
                self.assertEqual(dt_in, dt_out, f"Failed round trip test of {ttype!r}")
    ...
    def test_list(self):
        ...
        for ttype in self.ttypes:
            with self.subTest(ttype=ttype):
                ...
                self.assertListEqual(dt_in, dt_out, f"Failed round trip test of {ttype!r}")
    ...
    def test_tuple(self):
        ...
        for ttype in self.ttypes:
            with self.subTest(ttype=ttype):
                ...
                self.assertEqual(len(dt_in), len(dt_out))
                self.assertTupleEqual(dt_in, dt_out, f"Failed round trip test of {ttype!r}")
    ...
    def test_ndarray(self):
        ...
        for ttype in self.ttypes:
            with self.subTest(ttype=ttype):
                ...
                self.assertFalse((dt_in != dt_out).any(), f"Failed round trip test of {ttype!r}")
...
class SpiceTimeClassTestCase(unittest.TestCase):
    ...
    def test_ugps_to_utc_array(self):
        ...
        self.assertListEqual(["1980-01-06 00:00:00.000000", "1980-01-06 00:00:00.000001"], utc.tolist())
    ...
    def test_add_timedelta64_s_with_gps(self):
        # Must cast as an int because numpy won't allow adding floats to
        #   timedelta64 values.
